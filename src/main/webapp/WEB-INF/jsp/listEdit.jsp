...
<head>
    ...
    <script type="text/javascript">
        ...
        function time() {
            ...
            document.getElementById("showTime").innerHTML = "Time:"+ h + ":" + m + ":" + s;
...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">&nbsp;&nbsp;&nbsp;事件管理</h6>
        <c:forEach var="bean" items="${createList}">
            <div class="media text-muted pt-3">
                ...
                <a href="javascript:void(0);" onclick="delClass(${bean.id})">删除</a>&nbsp;&nbsp;
                <a href="/form.do?classId=${bean.id}">修改</a>
