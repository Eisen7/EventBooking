...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="my-3 p-3 bg-white rounded box-shadow">
            ...
            <h6 class="border-bottom border-gray pb-2 mb-0">未预定事件</h6>
            ...
            <div class="media text-muted pt-3">
                ...
                <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <strong class="text-gray-dark">课程名：${bean.className} 老师：${bean.teacher}</strong>
                        <a href="javascript:void(0);" onclick="booking(${bean.id})">Booking</a>
                    </div>
                    <span class="d-block">上课地点:${bean.address} 开始时间:${bean.date}</span>
                </div>
            </div>
            </c:forEach>
