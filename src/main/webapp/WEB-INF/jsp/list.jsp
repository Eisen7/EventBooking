...
<head>
    ...
    <script type="text/javascript">
        ...
        function time()
        {
            ...
            document.getElementById("showTime").innerHTML =  "当前时间："+h+"时"+m+"分"+s+"秒";
...
<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    <a class="navbar-brand" href="https://v4.bootcss.com/docs/4.0/examples/offcanvas/#"> 主页 </a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="https://v4.bootcss.com/docs/4.0/examples/offcanvas/#">选课管理 <span
                        class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://v4.bootcss.com/docs/4.0/examples/offcanvas/#">用户设置</a>
            </li>
...
<main role="main" class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">
        ...
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">用户:${user.username}</h6>
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">&nbsp;&nbsp;&nbsp;已预定事件</h6>
        ...
        <c:forEach var="bean" items="${bookingList}">
            <div class="media text-muted pt-3">
                ...
                <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                    <strong class="d-block text-gray-dark">课程名：${bean.className} 老师：${bean.teacher}</strong>
                    上课地点:${bean.address} 开始时间:${bean.date}
                </p>
                    <%--<a href="/classDel.do?classId=${bean.id}" onclick="">删除</a>--%>
                <a href="javascript:void(0);" onclick="delBooking(${bean.id})">删除</a>
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="media text-muted pt-3">
            ...
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <a href="https://v4.bootcss.com/docs/4.0/examples/offcanvas/#">Follow</a>
                </div>
        ...
        <div class="media text-muted pt-3">
            <img data-src="holder.js/32x32?theme=thumb&amp;bg=007bff&amp;fg=007bff&amp;size=1" alt="32x32"
                 class="mr-2 rounded"
                 src="data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2232%22%20height%3D%2232%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_163508a9302%20text%20%7B%20fill%3A%23007bff%3Bfont-weight%3Abold%3Bfont-family%3AArial%2C%20Helvetica%2C%20Open%20Sans%2C%20sans-serif%2C%20monospace%3Bfont-size%3A2pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_163508a9302%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%23007bff%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%2211.546875%22%20y%3D%2216.9%22%3E32x32%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E"
                 data-holder-rendered="true" style="width: 32px; height: 32px;">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <strong class="text-gray-dark">Full Name</strong>
